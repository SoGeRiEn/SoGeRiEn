...
$path = (string)(Sogerien::InputRequest()->url ?? '/proxy/checkout');
...
$domain = rtrim((string)(Sogerien::InputRequest()->domain ?: Sogerien::InputRequest()->sogerien_domain), '/');
$successBaseUrl = $domain . '/proxy/checkout/success';
$cancelBaseUrl = $domain . '/proxy/checkout/cancel';
...
<main class="container my-4 sog-ui">
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if (pc_s($service['service_id'] ?? '') !== ''): ?>
                                        <a class="btn btn-sm btn-outline-primary" href="/proxy/manage?service_id=<?= rawurlencode((string)$service['service_id']) ?>">Manage</a>
                                    <?php endif; ?>
                                </td>
                            </tr>
                        <?php endforeach; ?>
    ...
    <div class="d-flex gap-2">
        <a class="btn btn-primary" href="/my/proxies">My Proxies</a>
        <a class="btn btn-outline-secondary" href="/all_proxy">Back to catalog</a>
    </div>
</main>
<?php
