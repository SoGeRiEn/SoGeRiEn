...
function ar_user_link(mixed $value): string
{
    ...
    return '<span class="pm-user-actions">'
        . '<a href="/client/dashboard?user_id=' . $userId . '" target="_blank" rel="noopener noreferrer">' . $userId . '</a>'
        . '<a class="btn btn-sm btn-outline-primary" href="/admin/change-password?client_user_id=' . $userId . '">Password</a>'
        . '</span>';
}
...
$titleMap = [
    ...
    'password' => ['Change Client Password', 'Reset a client account password by login or email.'],
...
<main class="container my-4 sog-ui admin-reseller-page">
    <style>
        ...
        .pm-admin-tool{border:1px solid #e5e7eb;border-radius:8px;background:#fff;padding:14px}
        .pm-admin-tool h3{font-size:15px;margin:0 0 10px;color:#0f172a}
        ...
        .pm-admin-tool label{font-size:12px;color:#475569;margin-bottom:3px}
    ...
    <div class="pm-admin-head">
        ...
        <div class="pm-admin-head-actions">
            <a class="btn btn-primary" href="/admin/change-password">Change password</a>
    ...
    <?php if ($pageKey === 'provider'): ?>
        ...
        ar_admin_action_form('Issue traffic package', 'create_traffic_package',
            ...
            . '<div><label>Expires at</label><input class="form-control" name="expires_at" type="datetime-local" required></div>'
        ...
        ar_admin_action_form('Service lifecycle / traffic / access', 'admin_service_action',
            ...
            . '<div><label>Expires at</label><input class="form-control" name="expires_at" type="datetime-local"></div>'
